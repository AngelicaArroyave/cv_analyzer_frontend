    ...
    return (
        <header className="flex flex-col lg:flex-row justify-between items-center gap-10 mb-16 px-6 md:px-12 lg:px-16 max-w-[1400px] mx-auto pt-10">
            ...
            <div className="shrink-0 flex justify-center md:justify-end flex-1 w-full mt-8 lg:mt-0">
                <img src={bannerImg} alt="CV Analyzer" className="max-w-[550px] w-full object-contain" style={{ maskImage: "radial-gradient(ellipse 90% 90% at 50% 50%, black 45%, transparent 80%)", WebkitMaskImage: "radial-gradient(ellipse 90% 90% at 50% 50%, black 45%, transparent 80%)" }} />
            </div>
        </header>
    )
}
