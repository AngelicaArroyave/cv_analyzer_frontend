        ...
        <div className="flex flex-col gap-8 w-[calc(100%-3rem)] md:w-[calc(100%-6rem)] max-w-275 mx-auto relative z-10 -mt-4">
            ...
            <div>
                ...
                <div className='mt-10'>
                    ...
                    <button className='flex gap-3 mx-auto items-center cursor-pointer text-primary font-semibold mt-8 hover:bg-primary-soft/50 py-2.5 px-6 rounded-full transition-colors'>
